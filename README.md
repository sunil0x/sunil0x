...
[![Portfolio](https://img.shields.io/badge/Portfolio-sunilpaudel013.com.np-blue?style=for-the-badge&logo=google-chrome&logoColor=white)](https://www.sunilpaudel013.com.np/)
...
[![Download CV](https://img.shields.io/badge/📄_Download_CV-View_My_Resume-informational?style=for-the-badge)](./CV.pdf)
...
### ♟️ [Chess Game — Pygame](https://github.com/sunil0x/chess-game-pygame)
...
`Python` `Pygame` `Game Logic` `OOP`

---

### 📊 [NEPSE Data Analysis](https://github.com/sunil0x/nepse_dataanalysis)
> *Advanced Python Project*

An exploratory data analysis project focused on the **Nepal Stock Exchange (NEPSE)**. Uses Python's data ecosystem to surface insights, trends, and patterns from market data.

`Python` `Jupyter Notebook` `Pandas` `Matplotlib` `Data Analysis`
...
[![Portfolio](https://img.shields.io/badge/🌐_Portfolio-Visit_My_Website-blue?style=for-the-badge)](https://www.sunilpaudel013.com.np/)
[![Email](https://img.shields.io/badge/📧_Email-sunilpaudel@gmail.com-red?style=for-the-badge)](mailto:sunilpaudel@gmail.com)
